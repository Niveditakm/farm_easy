      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link addproduct active text-light bg-success" aria-current="page" href="addproduct.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">Add Products</h1>
          </div>
          <?php
          ...
          ?>
            ...
            ?>
              <div class="alert alert-danger alert-dismissible fade show mt-2" role="alert">
                <strong>Product Adding Failed!</strong>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>
            <?php
            }
          ...
          <form id="form" name="form" method="POST" action="saveproduct.php" class="text-center" enctype="multipart/form-data">
            <h4 class="h4 text-center mb-4">Add Product</h4>

            <div class="row justify-content-evenly">
              <div class="mb-3 col-md-4">
                <label class="form-label">Product Name :</label>
                <input type="text" class="form-control" name="name" id="name" placeholder="Product Name" required="required" />
              </div>
              <div class="mb-3 col-md-4">
            ...
            <div class="row justify-content-evenly">
              <div class="mb-3 col-md-4">
                ...
                <input type='file' id="getFile" name="getFile" class="form-control shadow-none" onchange="previewFile(this);" accept="image/*" required>
              </div>
              <div class="w-100"></div>
            ...
            <div class="row justify-content-evenly">
              <div class="mb-3 col-md-4">
                <input type="submit" class="btn btn-success w-100" name="butsave" id="butsave" />
              </div>
            </div>
