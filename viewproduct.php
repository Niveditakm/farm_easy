      ...
      <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
          <div class="position-sticky pt-3">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link farmer active text-light bg-success" aria-current="page" href="viewproduct.php">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h3 lead">View Products</h1>
          </div>
          <?php
            ...
            ?>
      <h4 class="text-center">Delete Product
        <hr>
      </h4>
      <form action="deleteproduct.php" class="text-center" method="POST">
        <div class="table-responsive">
              ...
              $sql = "SELECT * FROM farm_2021_product WHERE farm_2021_product_farmer = '$email'";
                ...
                if($stmt = mysqli_prepare($link, $sql))
                {
                  if(mysqli_stmt_execute($stmt))
                  {
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $name, $price, $category, $quantity, $farmer, $date, $image, $status);
          ...
          <?php
            ...
            ?>
      <h4 class="text-center">Change Status
        <hr>
      </h4>
      <form action="statusproduct.php" class="text-center" method="POST">
        <div class="table-responsive">
          <table class="table table-striped table-hover table-bordered shadow-sm align-middle">
            <thead class="bg-success bg-gradient text-white">
              <tr class="text-center">
